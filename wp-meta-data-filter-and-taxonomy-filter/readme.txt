...
Meta Data Filter & Taxonomies Filter ([MDTF](https://wp-filter.com/)) wordpress filter plugin. The main idea of MDTF – make your WordPress site content is filterable and searchable by meta fields and taxonomies on the same time.
...
### Meta Data and Taxonomies Filter Features:
...
🛠️&nbsp;Creating SEARCH/FILTER shortcodes by constructor
...
🛠️&nbsp;Built-in the meta-fields data constructor (checkbox, drop-down, multi drop-down, range-slider, calendar, textinput, label)
...
🛠️&nbsp;Specify for each meta fields the display mode on tye site front: drop-down, checkbox, range slider, calendar, textinput, label
...
🏷️&nbsp;Ready for Jigoshop! and EasyDigitalDownloads
...
&#9989;&nbsp;[HUSKY - WooCommerce Products Filter](https://wordpress.org/plugins/woocommerce-products-filter/): is an extendable, flexible and robust plugin for WooCommerce that allows your site customers filter products by products categories, attributes, tags, custom taxonomies and price. Supports latest version of the WooCommerce plugin. A must have plugin for your WooCommerce powered online store! Maximum flexibility!

&#9989;&nbsp;[BEAR - WooCommerce Bulk Editor Professional](https://wordpress.org/plugins/woo-bulk-editor/): BEAR - WordPress plugin for managing and bulk edit WooCommerce Products data in robust and flexible way! Be professionals with managing data of your woocommerce e-shop!

&#9989;&nbsp;[FOX - WooCommerce Currency Switcher](https://wordpress.org/plugins/woocommerce-currency-switcher/): is WooCommerce multi currency plugin, that allows your site visitors switch products prices currencies according to set currencies rates in the real time and pay in the selected currency (optionally). Allows to add any currency for WooCommerce store!
...
= 1.3.9 =
- 1 security issues are fixed, thanks to Ossacip Thanh and Patchstack

= 1.3.8 =
- 1 security issues are fixed, thanks to Roll and Patchstack

= 1.3.7 =
- 1 security issues are fixed, thanks to D01EXPLOIT and Patchstack

= 1.3.6 =
- 1 security issues are fixed, thanks to Zaim and Patchstack
...
- new hook mdtf_prohibited_post_types - allows to exclude specific post types from search query

= 1.3.1 =
- 1 security issue is fixed

= 1.3.0.1 =
- 1 js fix about plainOverlay
